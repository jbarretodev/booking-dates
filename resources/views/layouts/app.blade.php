<!DOCTYPE html>
<html lang="{{ \Illuminate\Support\Facades\Cache::get('codLang') }}">
{{--{{ dd(\Illuminate\Support\Facades\Cache::get('codLang')) }}--}}
<head>
    ...
    <div class="main-header">
        ...
        <div class="logo-header" data-background-color="blue">
            ...
            <a href="{{route('home')}}" class="logo">
                <img height="30" width="145" src="{{url($appearance->logo)}}" alt="navbar brand" class="navbar-brand br-5" />
            </a>
