            ...
            <div class="main-card card">
                <form class="form-horizontal" id="inputForm" novalidate="novalidate" enctype="multipart/form-data">
                    ...
                    <div class="form-group control-group form-inline ">
                        ...
                        <div class="col-md-9 controls square">
                            <input type="text" value="{{$appearance->theam_menu_color2}}" id="theam_menu_color2" name="theam_menu_color2" placeholder="#c725c3" required="required" class="coloris squire form-control input-full" data-validation-required-message="Page menu color is required" />
                            <span class="help-block"></span>
                        </div>
                    </div>
