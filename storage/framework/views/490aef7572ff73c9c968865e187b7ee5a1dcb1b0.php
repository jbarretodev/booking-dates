    ...
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            ...
            <div class="ml-md-auto py-2 py-md-0">
                <a href="booking-calendar" class="btn btn-secondary btn-round"><?php echo translate('Add New Booking'); ?></a>
            </div>
        </div>
    </div>
</div>
...
<div class="page-inner mt--5">
    <div class="row mt--2 div-top-card">
        ...
        <div class="col-md-3">
            <div class="card full-height">
                <div class="card-body">
                    <div class="fs-11rem"><?php echo translate('Total Done'); ?></div>
        ...
        <div class="col-md-3">
            <div class="card full-height">
                <div class="card-body">
                    <div class="fs-11rem"><?php echo translate('Total Cancel'); ?></div>
                    <div class="d-flex flex-wrap justify-content-around pb-2 pt-2">
                        <div class="px-2 pb-2 pb-md-0 text-center">
        ...
        <div class="col-md-3">
            <div class="card full-height">
                <div class="card-body">
                    <div class="fs-11rem"><?php echo translate('Total Approved'); ?></div>
                    <div class="d-flex flex-wrap justify-content-around pb-2 pt-2">
                        <div class="px-2 pb-2 pb-md-0 text-center">
        ...
        <div class="col-md-3">
            <div class="card full-height">
                <div class="card-body">
                    <div class="fs-11rem"><?php echo translate('Processing & Pending'); ?></div>
                    <div class="d-flex flex-wrap justify-content-around pb-2 pt-2">
                        <div class="px-2 pb-2 pb-md-0 text-center">
    ...
    <div class="row mt--2 div-today-service-card">
        <div class="col-md-7">
            <div class="card full-height">
                <div class="card-body">
                    <div class="card-title"><?php echo translate("Today's Service statistics"); ?></div>
                    <div class="card-category"><?php echo translate('Show all service statistics based on user branch permission.'); ?></div>
                    <div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
                        <div class="px-2 pb-2 pb-md-0 text-center">
                            <div id="divTotalBookingToday"></div>
                            <h6 class="fw-bold mt-3 mb-0"><?php echo translate('Total'); ?></h6>
                        </div>
                        <div class="px-2 pb-2 pb-md-0 text-center">
                            <div id="divDoneBookingToday"></div>
                            <h6 class="fw-bold mt-3 mb-0"><?php echo translate('Done'); ?></h6>
                        </div>
                        <div class="px-2 pb-2 pb-md-0 text-center">
                            <div id="divCancelBookingToday"></div>
                            <h6 class="fw-bold mt-3 mb-0"><?php echo translate('Cancel'); ?></h6>
                        </div>
                        <div class="px-2 pb-2 pb-md-0 text-center">
                            <div id="divApprovedBookingToday"></div>
                            <h6 class="fw-bold mt-3 mb-0"><?php echo translate('Approved'); ?></h6>
                        </div>
                        <div class="px-2 pb-2 pb-md-0 text-center">
                            <div id="divProcessingBookingToday"></div>
                            <h6 class="fw-bold mt-3 mb-0"><?php echo translate('Processing'); ?></h6>
                        </div>
                        <div class="px-2 pb-2 pb-md-0 text-center">
                            <div id="divPendingBookingToday"></div>
                            <h6 class="fw-bold mt-3 mb-0"><?php echo translate('Pending'); ?> </h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-5">
            <div class="card full-height">
                <div class="card-body">
                    <div class="card-title"><?php echo translate("Today's Income & Other Statistics"); ?></div>
                    <div class="row py-3">
                        <div class="col-md-6 d-flex flex-column justify-content-around">
                            <div>
                                <h6 class="fw-bold text-uppercase text-success op-8"><?php echo translate('Total Income'); ?></h6>
                                <h3 id="totalIncome" class="fw-bold">0</h3>
                            </div>
                            <div>
                                <h6 class="fw-bold text-uppercase text-danger op-8"><?php echo translate('Total Due'); ?></h6>
                                <h3 id="totalDue" class="fw-bold">0</h3>
                            </div>
                        </div>
                        <div class="col-md-6 d-flex flex-column justify-content-around">
                            <div>
                                <h6 class="fw-bold text-uppercase text-success op-8"><?php echo translate('Total Cash Payment'); ?></h6>
                                <h3 id="totalCash" class="fw-bold">0</h3>
                            </div>
                            <div>
                                <h6 class="fw-bold text-uppercase text-primary op-8"><?php echo translate('Total Online Payment'); ?></h6>
    ...
    <div class="row">
            ...
            <div class="card full-height">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title"><?php echo translate('Booking Info'); ?></div>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <div class="card-title"><?php echo translate('Top Booking Service'); ?></div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>