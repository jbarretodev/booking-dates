...
<script src="<?php echo e(dsAsset('js/lib/country-list.js')); ?>"></script>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group control-group form-inline controls">
                                    <label><?php echo e(translate('Customer Name')); ?> *</label>
                                    <input type="text" id="full_name" name="full_name" placeholder="<?php echo e(translate('Full name')); ?>" required data-validation-required-message="Customer name is required" class="form-control input-full" />
...
<script src="<?php echo e(dsAsset('js/custom/customer/customer.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/customer/customer.blade.php ENDPATH**/ ?>