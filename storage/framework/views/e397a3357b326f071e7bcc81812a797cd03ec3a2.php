<!DOCTYPE html>
<html lang="<?php echo e(\Illuminate\Support\Facades\Cache::get('codLang')); ?>">
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        ...
                        <form id="language-change-form" class="float-start" action="<?php echo e(route('change.language')); ?>" method="POST">
                            ...
                            <select id="cmbLang" class="me-3" name="lang_id">
                                ...
                                <option <?php echo e((Session::get('lang')!=null) && (Session::get('lang')['id'])==$lang->id?"selected":""); ?> value=<?php echo e($lang->id); ?>><?php echo html_entity_decode($lang->name); ?></option>
